  ...
  const cases: CaseStudy[] = [
    {
      ...
      afterVal: "28.8k / mo",
      chart: (
        <svg className={styles.chartSvg} viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path
        ...
        {cases.map((c, idx) => (
          ...
          >
            ...
            <h3 className={styles.headline}>
              <Link href={`/case-studies/${c.slug}`} className={styles.headlineLink}>
                {c.headline}
              </Link>
            </h3>
            ...
            {/* Read Detail Link */}
            <Link href={`/case-studies/${c.slug}`} className={styles.readMoreBtn}>
